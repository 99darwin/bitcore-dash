# Contributing to Bitcore-Divi

We're working hard to make *bitcore-divi* the most powerful JavaScript library for working with Divi. Our goal is to have *bitcore-divi* be a library that can be used by anyone interested in Divi, and to level expertise differences with great design and documentation.
...
These are some global design goals in bitcore-divi to which any change should adhere.
...
```sh
git remote add divi git@github.com:divicoin/bitcore-divi.git
git pull --rebase divi master
```
...
```
Finally go to [github.com/divicoin/bitcore-divi](https://github.com/divicoin/bitcore-divi) in your web browser and issue a new pull request.
...
[github.com/divicoin/bitcore-divi/issues](https://github.com/divicoin/bitcore-divi/issues).
